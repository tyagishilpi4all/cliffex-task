...
class DailyRider extends Component{

    render(){
        const {isTopRider} = this.props;
        return(
            <React.Fragment>
              <div className="daily-runner">
                  <h5 className="d-run">Daily Riders</h5>
                <div className="row">
                    {
                        isTopRider?isTopRider.map((obj,index)=>(
                            index<6?
                            <div className="col-lg-2 col-md-4 col-sm-6 col-6 mb-3" key={index}>
